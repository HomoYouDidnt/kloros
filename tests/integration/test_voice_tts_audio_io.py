...
Tests the communication between TTS and Audio I/O zooids via real ChemBus.
No mocks - uses actual ChemBus pub/sub with subprocess coordination.
"""
import os
import sys
import time
