"""Unit tests for LLM zooid - test in isolation with mocked ChemBus and HTTP."""
import os
import sys
import time
...
def zooid(monkeypatch):
    ...
    with patch('src.kloros_voice_llm.ChemPub', MockChemPub), \
         patch('src.kloros_voice_llm.ChemSub', MockChemSub):
