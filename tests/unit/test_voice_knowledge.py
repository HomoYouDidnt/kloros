"""Unit tests for Knowledge zooid - test in isolation with mocked ChemBus."""
import os
import sys
import time
...
def zooid(monkeypatch):
    ...
    with patch('src.kloros_voice_knowledge.ChemPub', MockChemPub), \
         patch('src.kloros_voice_knowledge.ChemSub', MockChemSub), \
...
class TestKnowledgeSignalEmission:
    """Test ChemBus signal emission for knowledge retrieval."""
