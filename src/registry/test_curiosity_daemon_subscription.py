...
class TestCuriosityCoreDaemonSubscription(unittest.TestCase):
    ...
    @patch('registry.curiosity_core.ChemSub')
    ...
    def test_convert_chembus_message_to_curiosity_question(self):
        from registry.curiosity_core import CuriosityCore, CuriosityQuestion, ActionClass
        ...
        questions = core._convert_daemon_message_to_questions(chembus_payload)
    ...
    def test_daemon_questions_merged_with_existing(self):
        from registry.curiosity_core import CuriosityCore, CuriosityQuestion, ActionClass, QuestionStatus
        from registry.capability_evaluator import CapabilityMatrix, CapabilityRecord, CapabilityState
    ...
    def test_daemon_question_fields_properly_mapped(self):
        from registry.curiosity_core import CuriosityCore, ActionClass
