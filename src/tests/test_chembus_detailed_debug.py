#!/usr/bin/env python3
"""
Detailed ChemBus debugging with step-by-step verification.
"""
...
def test_basic_zmq():
    """Test 1: Basic ZMQ XPUB/XSUB without ChemBus wrapper"""
...
def test_subscription_visibility():
    ...
    print("   Run: sudo journalctl -u kloros-chem-proxy.service -n 20 --no-pager | grep visibility")
...
def test_proxy_forwarding():
    ...
    print("   sudo journalctl -u kloros-chem-proxy.service -n 50 --no-pager | grep -E '(forward|XSUB socket)'")
...
def main():
    print("="*60)
    print("ChemBus Detailed Debugging Suite")
    print("="*60)
