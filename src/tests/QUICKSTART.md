...
## 2. Run Integration Tests (Requires UMN)
...
Run only unit tests (no UMN required):
```bash
...
### "UMN connection refused"
- Integration tests require UMN proxy
- Check if UMN is running: `systemctl status kloros-umn-proxy`
...
- Check that UMN proxy is responsive
