#!/usr/bin/env python3
"""
Debug test for ChemBus callback invocation.
"""
...
def main():
    logger.info("=== ChemBus Callback Debug Test ===")

    # Step 1: Create subscription
    logger.info("Step 1: Creating ChemSub subscription...")
    sub = ChemSub(
    ...
    if callback_invoked:
        ...
        logger.error("This indicates a ChemBus routing issue")
        return 1
