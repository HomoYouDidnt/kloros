...
class LLMRouter:
    ...
    LLAMA_SERVICES = {
        LLMMode.LIVE: LLMService(
            ...
            description="Fast chat and general queries (qwen2.5:7b)"
        ),
        LLMMode.THINK: LLMService(
            name="llama-think",
            port=8082,
            model="DeepSeek-R1-Distill-Qwen-7B-Q4_K_M.gguf",
            description="Deep reasoning (deepseek-r1:7b)"
        ),
        LLMMode.DEEP: LLMService(
            name="llama-think",
            port=8082,
            model="DeepSeek-R1-Distill-Qwen-7B-Q4_K_M.gguf",
            description="Deep analysis (deepseek-r1:7b)"
        ),
        LLMMode.CODE: LLMService(
            name="llama-code",
            port=8081,
            model="qwen2.5-coder-7b-instruct-q4_k_m.gguf",
            description="Code generation (qwen2.5-coder:7b)"
        ),
    }
