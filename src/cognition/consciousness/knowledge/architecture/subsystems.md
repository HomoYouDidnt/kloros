...
**Status:** DEPRECATED - Functionality migrated to housekeeping.py, failure_analyzer.py, and system_healing.py
...
**What it does:**
- Listens for affective signals on UMN (AFFECT_RESOURCE_STRAIN, AFFECT_MEMORY_PRESSURE, etc.)
...
- Actions not triggering → verify UMN signals are being emitted
...
**Architecture:**
- Publisher: `UMNPub` (sends signals)
- Subscriber: `UMNSub` (receives signals)
...
Interoception detects → emits AFFECT_RESOURCE_STRAIN
    ↓
System healing throttles investigations
    ↓
...
- System healing: Some skips due to cooldown
...
- System healing: Frequent interventions
