...
the complete pipeline: consciousness → UMN → action subscribers.
"""
...
from src.cognition.mind.consciousness.affective_signals import AffectSignalEmitter
from src.cognition.mind.consciousness.affective_core import PrimaryAffects
from src.cognition.mind.consciousness.affective_introspection import AffectiveIntrospection, Urgency
...
def test_memory_pressure_signal():
    ...
    # Emit signals
    print("\n[test] Emitting affective signals via UMN...")
    ...
    print("[test] Expected: system healing should log MEMORY_PRESSURE signal")
...
if __name__ == "__main__":
    ...
    print("="*70)
    print("\nThis test will emit affective signals via UMN.")
