#!/usr/bin/env python3
"""
Simple UMN Signal Emission Test

Directly emits affective signals via UMN to test the subscriber pipeline.
"""
...
from src.orchestration.core.umn_bus import UMNPub, UMNMessage
