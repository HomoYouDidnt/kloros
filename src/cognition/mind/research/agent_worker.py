...
class RealAgentWorker:
    ...
    def __init__(self, genome: AgentGenome, agentflow_runner=None):
        ...
        if agentflow_runner is None:
            from src.agents.agentflow.planner import SimplePlanner
            from src.agents.agentflow.executor import Executor
            from src.agents.agentflow.verifier import Verifier
            from src.agents.agentflow.generator import Generator
            from src.agents.agentflow.runner import AgentFlowRunner
    ...
    def __call__(self, inputs: Dict[str, Any], comm_state: Dict[str, Any]) -> Dict[str, Any]:
        ...
        """
        from src.agents.agentflow.types import TaskSpec
