...
from registry.curiosity_core import SystemResourceMonitor, CuriosityQuestion, ActionClass, QuestionStatus
...
def test_archive_manager_discovery_integration():
    ...
    try:
        ...
        print(f"  ⚠ ChemBus not available ({e}), using mock")
        class MockChemPub:
            def emit(self, topic, **kwargs):
                pass
        chem_pub = MockChemPub()
