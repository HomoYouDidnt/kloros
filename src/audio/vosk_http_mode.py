...
class VoskHTTPAudioMode:
    ...
    def __init__(
        ...
        # Configuration
        self.wake_phrases = ["chloris", "good morning chloris"]
        ...
        self.audio_buffer = []
        self.buffer_duration_ms = 1000  # Accumulate 1 second before recognition
    ...
    def _apply_gain(self, audio_chunk: np.ndarray, target_rms: float = 0.1) -> np.ndarray:
        ...
        Args:
            ...
            target_rms: Target RMS level (0.1 = 10% of max)
    ...
    def _recognition_loop(self):
        ...
        try:
            ...
            for chunk in self.audio_backend.chunks(block_ms=200):  # 200ms chunks
                ...
                if chunk_count % 50 == 0:
                    print(f"[vosk-http-mode] Vosk result: {result}")
